(() => {
    ...
    function getKeyEventReceiver() {
        return gGoogleDocsEditor || document.activeElement || document.documentElement;
    }

    class Panel {
        constructor() {
            log("Initialize panel");
        ...
        selectNext() {
            this._selectCandidateByIndex((this._index + 1) % this._filteredCandidates.length);
        }
